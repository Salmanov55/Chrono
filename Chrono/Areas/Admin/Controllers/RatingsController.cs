    ...
    public class RatingsController : Controller
    {
        ...
        public async Task<IActionResult> Index()
        {
            return _context.Ratings != null ?
                        ...
                        Problem("Entity set 'AppDbContext.Ratings'  is null.");
        }
        ...
        public async Task<IActionResult> Create([Bind("Vote,ProductId,Id")] Rating rating)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Vote,ProductId,Id")] Rating rating)
        {
            if (id != rating.Id)
            {
                return NotFound();
